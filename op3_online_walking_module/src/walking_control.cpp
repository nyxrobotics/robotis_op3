                                      ...
                                      int P_col)
{
  ...
  f_ = preview_control_->calcPreviewParam(preview_time_, control_cycle_, lipm_height_, K_, P_);
...
void WalkingControl::getWalkingAccleration(std::vector<double_t>& l_foot_accel, std::vector<double_t>& r_foot_accel,
