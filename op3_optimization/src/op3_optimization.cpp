...
bool calcPreviewParam(double control_cycle, double lipm_height)
{
  ...
  double matrix_Q[] = { Q.coeff(0, 0), Q.coeff(1, 0), Q.coeff(2, 0), Q.coeff(3, 0), Q.coeff(0, 1), Q.coeff(1, 1),
                        Q.coeff(2, 1), Q.coeff(3, 1), Q.coeff(0, 2), Q.coeff(1, 2), Q.coeff(2, 2), Q.coeff(3, 2),
  ...
  robotis_framework::ScilabOptimization::solveRiccatiEquation(
...
int main(int argc, char** argv)
{
  ...
  ros::ServiceServer get_preview_matrix_server =
      nh.advertiseService("/robotis/online_walking/get_preview_matrix", getPreviewMatrixCallback);
