...
void OP3Kinematics::initialize(Eigen::MatrixXd pelvis_position, Eigen::MatrixXd pelvis_orientation)
{
  ...
  min_position_limit.push_back(-180.0);
  max_position_limit.push_back(180.0);  // r_leg_hip_r
  min_position_limit.push_back(-180.0);
  max_position_limit.push_back(180.0);  // r_leg_hip_p
  min_position_limit.push_back(-180.0);
  max_position_limit.push_back(180.0);  // r_leg_kn_p
  min_position_limit.push_back(-180.0);
  max_position_limit.push_back(180.0);  // r_leg_an_p
  min_position_limit.push_back(-180.0);
  max_position_limit.push_back(180.0);  // r_leg_an_r
                                           ...
                                           std::vector<double_t>& lleg_orientation)
{
  ...
  //  ROS_INFO("rleg position x : %f y: %f, z: %f", rleg_pose_.position.x, rleg_pose_.position.y,
  //  rleg_pose_.position.z);
  ...
  //  ROS_INFO("lleg position x : %f y: %f, z: %f", lleg_pose_.position.x, lleg_pose_.position.y,
  //  lleg_pose_.position.z);
...
bool OP3Kinematics::solveInverseKinematics(std::vector<double_t>& rleg_output, Eigen::MatrixXd rleg_target_position,
