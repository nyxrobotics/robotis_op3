...
{
public:
  WalkingControl(double control_cycle, double dsp_ratio, double lipm_height, double foot_height_max,
  ...
  void initialize(op3_online_walking_module_msgs::Step2DArray foot_step_2d, std::vector<double_t> init_body_pos,
  ...
  void getWalkingPosition(std::vector<double_t>& l_foot_pos, std::vector<double_t>& r_foot_pos,
                          std::vector<double_t>& body_pos);
  void getWalkingVelocity(std::vector<double_t>& l_foot_vel, std::vector<double_t>& r_foot_vel,
